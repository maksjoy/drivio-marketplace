...
insert into public.listings(id,user_id,seller_name,seller_email,make,model,year,price,mileage,fuel,status,created_at) values('20000000-0000-4000-8000-000000000001',auth.uid(),'Test','seller-test@example.invalid','Porsche','911',2020,50000,50000,'Gasoline','pending',now()-interval '2 minutes');
...
insert into public.listings(user_id,seller_name,seller_email,make,model,year,price,mileage,fuel,created_at) select auth.uid(),'Test','test@example.invalid','Ford','Focus',2020,5000,50000,'Gasoline',now()-interval '2 minutes' from generate_series(1,2);
